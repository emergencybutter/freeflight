...
- The Flight Plan view: pick departure/arrival airports, optionally
  "Set SID"/"Set STAR" by browsing that airport's real procedures (and
  a transition, if it has more than one), and add fixes/navaids/airways
