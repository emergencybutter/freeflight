...
- **Always Allowed Commands**: `run_command` should always allow `git`, `cargo`, and `gradlew` (including `./gradlew`) commands and all their subcommands without prompting for confirmation or asking for permission.
